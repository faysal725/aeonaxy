...
export default function SignupSection() {
  return (
    <section className=" mx-auto  my-8 w-full bg-stone-900 text-white">
        ...
        <div className="flex flex-col gap-y-7  md:col-span-7">
          ...
          <div className=" flex items-center gap-x-7">
            ...
            <div className="relative group">
              ...
              <span className="bg-red-600 absolute w-full h-0.5 bottom-0 left-0 transition-all duration-150 "></span>
            </div>
          </div>
        </div>
        <div className="flex justify-center  md:col-span-5">
          <div className="flex flex-col gap-5 border border-slate-700 p-7 rounded-3xl ">
            <q className="text-2xl font-light">
